...
class EnactingAmendmentTests(@Autowired val client: TestRestTemplate) : BaseEndToEndTest() {
    private val amend = AmendmentInputModel(2, 8, 11, "amend", "text" )
    private val request = createRequest(amend)
    @Test
    ...
    private val request4 = createRequest(amend4)
    @Test
    ...
    private val request1 = createRequest(amend1)
    @Test
    ...
    private val request2 = createRequest(amend2)
    @Test
    ...
    private val request3 = createRequest(amend3)
    @Test
