...
interface UserAuthenticator {
     ...
     * * Upon successful authentication, this function returns a result object containing a JWT Token which the user to more readily * provide authentication in future API calls.
     ...
     * * Per business rules, this function will fail if the login name is not unique or if the password does not pass specified * password strength rules. Otherwise, this function will create the user and return a result object with a JWT Token.
