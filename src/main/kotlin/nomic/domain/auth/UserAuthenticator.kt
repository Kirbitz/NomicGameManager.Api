...
interface UserAuthenticator {
     ...
     * 
     * Upon successful authentication, this function returns a result object containing a JWT Token which the user to more readily 
     * provide authentication in future API calls.
     * 
